...
public final class _FEMInitialTemperatureDelM extends Ice._ObjectDelM implements _FEMInitialTemperatureDel
{
    ...
    getNode(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getNode", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
    ...
    public void
    setFields(FEMInitialTemperatureFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
