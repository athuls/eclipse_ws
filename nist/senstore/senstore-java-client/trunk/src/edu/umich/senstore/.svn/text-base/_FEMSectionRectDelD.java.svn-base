...
public final class _FEMSectionRectDelD extends Ice._ObjectDelD implements _FEMSectionRectDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSectionRectFieldsHolder __result = new FEMSectionRectFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSectionRect __servant = null;
                    try
                    {
                        __servant = (FEMSectionRect)__obj;
                    }
    ...
    public void
    setFields(final FEMSectionRectFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
