...
public final class _FEMSectionPropDelD extends Ice._ObjectDelD implements _FEMSectionPropDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSectionPropFieldsHolder __result = new FEMSectionPropFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSectionProp __servant = null;
                    try
                    {
                        __servant = (FEMSectionProp)__obj;
                    }
    ...
    public void
    setFields(final FEMSectionPropFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
