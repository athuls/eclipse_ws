...
public final class _SensorDelD extends Ice._ObjectDelD implements _SensorDel
{
    public SensorFields
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final SensorFieldsHolder __result = new SensorFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    Sensor __servant = null;
                    try
                    {
                        __servant = (Sensor)__obj;
                    }
    ...
    public void
    setFields(final SensorFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
