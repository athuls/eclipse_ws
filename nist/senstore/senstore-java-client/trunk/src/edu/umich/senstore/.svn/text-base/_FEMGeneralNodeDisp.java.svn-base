...
public abstract class _FEMGeneralNodeDisp extends Ice.ObjectImpl implements FEMGeneralNode
{
    protected void
    ...
    ___getFields(FEMGeneralNode __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        FEMGeneralNodeFields __ret = __obj.getFields(__current);
        __ret.__write(__os);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___setFields(FEMGeneralNode __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
    ...
    public static Ice.DispatchStatus
    ___getGroup(FEMGeneralNode __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    public static Ice.DispatchStatus
    ___getNode(FEMGeneralNode __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type SenStore::FEMGeneralNode was not generated with stream support";
        throw ex;
    }
