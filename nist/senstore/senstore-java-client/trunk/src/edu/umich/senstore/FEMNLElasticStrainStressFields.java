...
public final class FEMNLElasticStrainStressFields implements java.lang.Cloneable, java.io.Serializable
{
    public long id;
    ...
    public FEMNLElasticStrainStressFields(long id, int mMaterialID, int mRecordNumber, double mStrain, double mStress)
    {
        this.id = id;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        FEMNLElasticStrainStressFields _r = null;
        try
        {
            _r = (FEMNLElasticStrainStressFields)rhs;
        }
