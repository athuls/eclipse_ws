...
public final class _FEMAxesNodeDelM extends Ice._ObjectDelM implements _FEMAxesNodeDel
{
    ...
    public void
    setFields(FEMAxesNodeFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
