...
public final class _FEMBeamNodeDelD extends Ice._ObjectDelD implements _FEMBeamNodeDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMBeamNodeFieldsHolder __result = new FEMBeamNodeFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMBeamNode __servant = null;
                    try
                    {
                        __servant = (FEMBeamNode)__obj;
                    }
    ...
    public void
    setFields(final FEMBeamNodeFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
