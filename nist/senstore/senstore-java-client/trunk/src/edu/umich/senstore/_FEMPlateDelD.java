...
public final class _FEMPlateDelD extends Ice._ObjectDelD implements _FEMPlateDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMPlateFieldsHolder __result = new FEMPlateFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMPlate __servant = null;
                    try
                    {
                        __servant = (FEMPlate)__obj;
                    }
    ...
    public void
    setFields(final FEMPlateFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
