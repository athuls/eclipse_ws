...
public abstract class _FEMGroupDisp extends Ice.ObjectImpl implements FEMGroup
{
    protected void
    ...
    ___getFields(FEMGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        FEMGroupFields __ret = __obj.getFields(__current);
        __ret.__write(__os);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___setFields(FEMGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
    ...
    public static Ice.DispatchStatus
    ___getStructure(FEMGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type SenStore::FEMGroup was not generated with stream support";
        throw ex;
    }
