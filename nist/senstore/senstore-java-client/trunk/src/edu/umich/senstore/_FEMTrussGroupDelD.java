...
public final class _FEMTrussGroupDelD extends Ice._ObjectDelD implements _FEMTrussGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMTrussGroupFieldsHolder __result = new FEMTrussGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMTrussGroup __servant = null;
                    try
                    {
                        __servant = (FEMTrussGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMTrussGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
