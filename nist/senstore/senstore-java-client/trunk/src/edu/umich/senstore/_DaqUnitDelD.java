...
public final class _DaqUnitDelD extends Ice._ObjectDelD implements _DaqUnitDel
{
    ...
    public void
    setFields(final DaqUnitFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
