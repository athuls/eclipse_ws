...
public abstract class _FEMShellGroupDisp extends Ice.ObjectImpl implements FEMShellGroup
{
    protected void
    ...
    ___getFields(FEMShellGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        FEMShellGroupFields __ret = __obj.getFields(__current);
        __ret.__write(__os);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___setFields(FEMShellGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
    ...
    public static Ice.DispatchStatus
    ___getGroup(FEMShellGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    public static Ice.DispatchStatus
    ___getMaterial(FEMShellGroup __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type SenStore::FEMShellGroup was not generated with stream support";
        throw ex;
    }
