...
public final class _FEMThreeDSolidGroupDelD extends Ice._ObjectDelD implements _FEMThreeDSolidGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMThreeDSolidGroupFieldsHolder __result = new FEMThreeDSolidGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMThreeDSolidGroup __servant = null;
                    try
                    {
                        __servant = (FEMThreeDSolidGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMThreeDSolidGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
