...
public final class _FEMSkewDOFDelD extends Ice._ObjectDelD implements _FEMSkewDOFDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSkewDOFFieldsHolder __result = new FEMSkewDOFFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSkewDOF __servant = null;
                    try
                    {
                        __servant = (FEMSkewDOF)__obj;
                    }
    ...
    public void
    setFields(final FEMSkewDOFFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
