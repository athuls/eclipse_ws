...
public final class _StructureDelD extends Ice._ObjectDelD implements _StructureDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final StructureFieldsHolder __result = new StructureFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    Structure __servant = null;
                    try
                    {
                        __servant = (Structure)__obj;
                    }
    ...
    public void
    setFields(final StructureFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
