...
public final class _FEMBeamLoadDelD extends Ice._ObjectDelD implements _FEMBeamLoadDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMBeamLoadFieldsHolder __result = new FEMBeamLoadFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMBeamLoad __servant = null;
                    try
                    {
                        __servant = (FEMBeamLoad)__obj;
                    }
    ...
    public void
    setFields(final FEMBeamLoadFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
