...
public interface _FEMShellOperations
{
    FEMShellFields getFields(Ice.Current __current);

    void setFields(FEMShellFields fields, String[] fieldNames, Ice.Current __current);
