...
public final class _FEMTrussDelD extends Ice._ObjectDelD implements _FEMTrussDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMTrussFieldsHolder __result = new FEMTrussFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMTruss __servant = null;
                    try
                    {
                        __servant = (FEMTruss)__obj;
                    }
    ...
    {
        final Ice.Current __current = new Ice.Current();
        __initCurrent(__current, "getMaterial", Ice.OperationMode.Idempotent, __ctx);
        final FEMMaterialPrxHolder __result = new FEMMaterialPrxHolder();
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getMaterial(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public void
    setFields(final FEMTrussFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
