...
public final class _FEMShellAxesOrthoDelD extends Ice._ObjectDelD implements _FEMShellAxesOrthoDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMShellAxesOrthoFieldsHolder __result = new FEMShellAxesOrthoFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMShellAxesOrtho __servant = null;
                    try
                    {
                        __servant = (FEMShellAxesOrtho)__obj;
                    }
    ...
    public void
    setFields(final FEMShellAxesOrthoFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
