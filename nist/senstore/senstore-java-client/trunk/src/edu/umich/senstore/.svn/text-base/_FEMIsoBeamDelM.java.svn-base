...
public final class _FEMIsoBeamDelM extends Ice._ObjectDelM implements _FEMIsoBeamDel
{
    public FEMNodePrx
    getAUX(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAUX", Ice.OperationMode.Idempotent, __ctx);
        try
        {
    ...
    public void
    setFields(FEMIsoBeamFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
