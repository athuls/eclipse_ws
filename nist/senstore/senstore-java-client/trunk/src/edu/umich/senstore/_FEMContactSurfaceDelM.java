...
public final class _FEMContactSurfaceDelM extends Ice._ObjectDelM implements _FEMContactSurfaceDel
{
    ...
    public void
    setFields(FEMContactSurfaceFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
