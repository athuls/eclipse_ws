...
public final class _FEMSkewSysAnglesDelM extends Ice._ObjectDelM implements _FEMSkewSysAnglesDel
{
    ...
    public void
    setFields(FEMSkewSysAnglesFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
