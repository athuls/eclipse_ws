...
public final class FEMThermoIsoMaterialsFields implements java.lang.Cloneable, java.io.Serializable
{
    public long id;
    ...
    public FEMThermoIsoMaterialsFields(long id, double mDensity, int mMaterialID, double mTREF)
    {
        this.id = id;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        FEMThermoIsoMaterialsFields _r = null;
        try
        {
            _r = (FEMThermoIsoMaterialsFields)rhs;
        }
