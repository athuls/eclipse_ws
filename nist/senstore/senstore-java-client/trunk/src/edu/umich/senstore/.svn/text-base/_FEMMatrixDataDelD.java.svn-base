...
public final class _FEMMatrixDataDelD extends Ice._ObjectDelD implements _FEMMatrixDataDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMMatrixDataFieldsHolder __result = new FEMMatrixDataFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMMatrixData __servant = null;
                    try
                    {
                        __servant = (FEMMatrixData)__obj;
                    }
    ...
    public void
    setFields(final FEMMatrixDataFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
