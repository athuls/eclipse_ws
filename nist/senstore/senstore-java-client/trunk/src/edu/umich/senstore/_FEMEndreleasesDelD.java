...
public final class _FEMEndreleasesDelD extends Ice._ObjectDelD implements _FEMEndreleasesDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMEndreleasesFieldsHolder __result = new FEMEndreleasesFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMEndreleases __servant = null;
                    try
                    {
                        __servant = (FEMEndreleases)__obj;
                    }
    ...
    public void
    setFields(final FEMEndreleasesFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
