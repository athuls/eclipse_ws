...
public final class _FEMShellDOFDelD extends Ice._ObjectDelD implements _FEMShellDOFDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMShellDOFFieldsHolder __result = new FEMShellDOFFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMShellDOF __servant = null;
                    try
                    {
                        __servant = (FEMShellDOF)__obj;
                    }
    ...
    public void
    setFields(final FEMShellDOFFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
