...
public final class _FEMGeneralNodeDelD extends Ice._ObjectDelD implements _FEMGeneralNodeDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMGeneralNodeFieldsHolder __result = new FEMGeneralNodeFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMGeneralNode __servant = null;
                    try
                    {
                        __servant = (FEMGeneralNode)__obj;
                    }
    ...
    public void
    setFields(final FEMGeneralNodeFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
