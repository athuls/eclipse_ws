...
public final class _ExperimentStructureDataDelM extends Ice._ObjectDelM implements _ExperimentStructureDataDel
{
    ...
    public void
    setFields(ExperimentStructureDataFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
