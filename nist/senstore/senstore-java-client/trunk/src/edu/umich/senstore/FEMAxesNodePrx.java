...
public interface FEMAxesNodePrx extends Ice.ObjectPrx
{
    public FEMAxesNodeFields getFields();
    public FEMAxesNodeFields getFields(java.util.Map<String, String> __ctx);

    public void setFields(FEMAxesNodeFields fields, String[] fieldNames);
    public void setFields(FEMAxesNodeFields fields, String[] fieldNames, java.util.Map<String, String> __ctx);
