...
public final class _FEMBoundaryDelD extends Ice._ObjectDelD implements _FEMBoundaryDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMBoundaryFieldsHolder __result = new FEMBoundaryFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMBoundary __servant = null;
                    try
                    {
                        __servant = (FEMBoundary)__obj;
                    }
    ...
    public void
    setFields(final FEMBoundaryFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
