...
public final class _FEMTwoDSolidGroupDelM extends Ice._ObjectDelM implements _FEMTwoDSolidGroupDel
{
    public FEMNodePrx
    ...
    public void
    setFields(FEMTwoDSolidGroupFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
