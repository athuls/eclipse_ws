...
public final class _FEMNodeDelM extends Ice._ObjectDelM implements _FEMNodeDel
{
    ...
    getSystem(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getSystem", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
