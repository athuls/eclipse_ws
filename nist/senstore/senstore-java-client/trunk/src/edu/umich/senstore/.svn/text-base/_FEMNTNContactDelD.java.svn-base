...
public final class _FEMNTNContactDelD extends Ice._ObjectDelD implements _FEMNTNContactDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMNTNContactFieldsHolder __result = new FEMNTNContactFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMNTNContact __servant = null;
                    try
                    {
                        __servant = (FEMNTNContact)__obj;
                    }
    ...
    public void
    setFields(final FEMNTNContactFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
