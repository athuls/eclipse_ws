...
public final class _FEMSkewDOFDelM extends Ice._ObjectDelM implements _FEMSkewDOFDel
{
    ...
    public void
    setFields(FEMSkewDOFFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
