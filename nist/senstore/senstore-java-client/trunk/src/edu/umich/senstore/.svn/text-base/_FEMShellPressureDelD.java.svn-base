...
public final class _FEMShellPressureDelD extends Ice._ObjectDelD implements _FEMShellPressureDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMShellPressureFieldsHolder __result = new FEMShellPressureFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMShellPressure __servant = null;
                    try
                    {
                        __servant = (FEMShellPressure)__obj;
                    }
    ...
    public void
    setFields(final FEMShellPressureFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
