...
public final class Float64Signal implements java.lang.Cloneable, java.io.Serializable
{
    public long[] shape;
    ...
    public Float64Signal()
    {
    }

    public Float64Signal(long[] shape, double[] data, double[] t)
    {
        this.shape = shape;
        this.data = data;
        this.t = t;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        Float64Signal _r = null;
        try
        {
            _r = (Float64Signal)rhs;
        }
