...
public final class _FEMMatrixSetsDelD extends Ice._ObjectDelD implements _FEMMatrixSetsDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMMatrixSetsFieldsHolder __result = new FEMMatrixSetsFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMMatrixSets __servant = null;
                    try
                    {
                        __servant = (FEMMatrixSets)__obj;
                    }
    ...
    public void
    setFields(final FEMMatrixSetsFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
