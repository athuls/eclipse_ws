...
public final class _TransducerDelD extends Ice._ObjectDelD implements _TransducerDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final TransducerFieldsHolder __result = new TransducerFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    Transducer __servant = null;
                    try
                    {
                        __servant = (Transducer)__obj;
                    }
    ...
    public void
    setFields(final TransducerFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
