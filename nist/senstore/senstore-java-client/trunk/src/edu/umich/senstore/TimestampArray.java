...
public final class TimestampArray implements java.lang.Cloneable, java.io.Serializable
{
    public long[] shape;
    ...
    public TimestampArray(long[] shape, double[] data)
    {
        this.shape = shape;
        this.data = data;
    }
    ...
    equals(java.lang.Object rhs)
    {
        ...
        TimestampArray _r = null;
        try
        {
            _r = (TimestampArray)rhs;
        }
