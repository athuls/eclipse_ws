...
public final class _FEMBeamDelM extends Ice._ObjectDelM implements _FEMBeamDel
{
    public FEMNodePrx
    getAuxNode(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAuxNode", Ice.OperationMode.Idempotent, __ctx);
        try
        {
