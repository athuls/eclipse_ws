...
public final class _FEMShellGroupDelD extends Ice._ObjectDelD implements _FEMShellGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMShellGroupFieldsHolder __result = new FEMShellGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMShellGroup __servant = null;
                    try
                    {
                        __servant = (FEMShellGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMShellGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
