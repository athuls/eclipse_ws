...
public final class StringSignal implements java.lang.Cloneable, java.io.Serializable
{
    public long[] shape;
    ...
    public StringSignal(long[] shape, String[] data, double[] t)
    {
        this.shape = shape;
        this.data = data;
        this.t = t;
    ...
    __write(IceInternal.BasicStream __os)
    {
        ...
        StringListHelper.write(__os, data);
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        data = StringListHelper.read(__is);
