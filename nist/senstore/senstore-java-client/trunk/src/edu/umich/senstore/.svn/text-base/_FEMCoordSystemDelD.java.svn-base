...
public final class _FEMCoordSystemDelD extends Ice._ObjectDelD implements _FEMCoordSystemDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMCoordSystemFieldsHolder __result = new FEMCoordSystemFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMCoordSystem __servant = null;
                    try
                    {
                        __servant = (FEMCoordSystem)__obj;
                    }
    ...
    public void
    setFields(final FEMCoordSystemFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
