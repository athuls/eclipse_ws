...
public final class _FEMSectionBoxDelD extends Ice._ObjectDelD implements _FEMSectionBoxDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSectionBoxFieldsHolder __result = new FEMSectionBoxFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSectionBox __servant = null;
                    try
                    {
                        __servant = (FEMSectionBox)__obj;
                    }
    ...
    public void
    setFields(final FEMSectionBoxFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
