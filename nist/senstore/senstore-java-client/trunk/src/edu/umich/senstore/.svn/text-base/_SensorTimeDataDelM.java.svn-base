...
public final class _SensorTimeDataDelM extends Ice._ObjectDelM implements _SensorTimeDataDel
{
    ...
    public void
    setFields(SensorTimeDataFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
