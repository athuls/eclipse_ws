...
public final class _FEMSpringGroupDelD extends Ice._ObjectDelD implements _FEMSpringGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSpringGroupFieldsHolder __result = new FEMSpringGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSpringGroup __servant = null;
                    try
                    {
                        __servant = (FEMSpringGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMSpringGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
