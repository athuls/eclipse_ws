...
public final class _FEMNMTimeMassDelD extends Ice._ObjectDelD implements _FEMNMTimeMassDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMNMTimeMassFieldsHolder __result = new FEMNMTimeMassFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMNMTimeMass __servant = null;
                    try
                    {
                        __servant = (FEMNMTimeMass)__obj;
                    }
    ...
    public void
    setFields(final FEMNMTimeMassFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
