...
public final class _FEMPointsDelD extends Ice._ObjectDelD implements _FEMPointsDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMPointsFieldsHolder __result = new FEMPointsFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMPoints __servant = null;
                    try
                    {
                        __servant = (FEMPoints)__obj;
                    }
    ...
    public void
    setFields(final FEMPointsFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
