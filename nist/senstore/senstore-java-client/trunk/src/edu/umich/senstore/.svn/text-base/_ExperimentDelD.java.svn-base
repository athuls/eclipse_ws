...
public final class _ExperimentDelD extends Ice._ObjectDelD implements _ExperimentDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final ExperimentFieldsHolder __result = new ExperimentFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    Experiment __servant = null;
                    try
                    {
                        __servant = (Experiment)__obj;
                    }
    ...
    public void
    setFields(final ExperimentFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
