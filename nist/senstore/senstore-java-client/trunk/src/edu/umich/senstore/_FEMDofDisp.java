...
public abstract class _FEMDofDisp extends Ice.ObjectImpl implements FEMDof
{
    protected void
    ...
    ___getFields(FEMDof __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        FEMDofFields __ret = __obj.getFields(__current);
        __ret.__write(__os);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___setFields(FEMDof __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
    ...
    public static Ice.DispatchStatus
    ___getStructure(FEMDof __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    public static Ice.DispatchStatus
    ___getNode(FEMDof __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type SenStore::FEMDof was not generated with stream support";
        throw ex;
    }
