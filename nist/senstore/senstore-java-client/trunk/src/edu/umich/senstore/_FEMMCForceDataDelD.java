...
public final class _FEMMCForceDataDelD extends Ice._ObjectDelD implements _FEMMCForceDataDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMMCForceDataFieldsHolder __result = new FEMMCForceDataFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMMCForceData __servant = null;
                    try
                    {
                        __servant = (FEMMCForceData)__obj;
                    }
    ...
    public void
    setFields(final FEMMCForceDataFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
