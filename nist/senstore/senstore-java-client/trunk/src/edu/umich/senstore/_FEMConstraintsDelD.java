...
public final class _FEMConstraintsDelD extends Ice._ObjectDelD implements _FEMConstraintsDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMConstraintsFieldsHolder __result = new FEMConstraintsFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMConstraints __servant = null;
                    try
                    {
                        __servant = (FEMConstraints)__obj;
                    }
    ...
    public void
    setFields(final FEMConstraintsFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
