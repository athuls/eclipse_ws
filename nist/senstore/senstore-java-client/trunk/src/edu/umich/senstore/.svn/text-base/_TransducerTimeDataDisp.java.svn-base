...
public abstract class _TransducerTimeDataDisp extends Ice.ObjectImpl implements TransducerTimeData
{
    protected void
    ...
    ___getFields(TransducerTimeData __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
        TransducerTimeDataFields __ret = __obj.getFields(__current);
        __ret.__write(__os);
        return Ice.DispatchStatus.DispatchOK;
    }

    public static Ice.DispatchStatus
    ___setFields(TransducerTimeData __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
    ...
    public static Ice.DispatchStatus
    ___getTransducer(TransducerTimeData __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    public static Ice.DispatchStatus
    ___getSensor(TransducerTimeData __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    public static Ice.DispatchStatus
    ___getNode(TransducerTimeData __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.is().skipEmptyEncaps();
        IceInternal.BasicStream __os = __inS.os();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type SenStore::TransducerTimeData was not generated with stream support";
        throw ex;
    }
