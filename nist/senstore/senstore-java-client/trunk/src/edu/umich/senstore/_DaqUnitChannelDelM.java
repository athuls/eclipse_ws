...
public final class _DaqUnitChannelDelM extends Ice._ObjectDelM implements _DaqUnitChannelDel
{
    ...
    getUnit(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getUnit", Ice.OperationMode.Idempotent, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            try
