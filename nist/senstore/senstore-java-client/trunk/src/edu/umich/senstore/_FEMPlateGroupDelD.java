...
public final class _FEMPlateGroupDelD extends Ice._ObjectDelD implements _FEMPlateGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMPlateGroupFieldsHolder __result = new FEMPlateGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMPlateGroup __servant = null;
                    try
                    {
                        __servant = (FEMPlateGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMPlateGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
