...
public final class _FEMMatricesDelD extends Ice._ObjectDelD implements _FEMMatricesDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMMatricesFieldsHolder __result = new FEMMatricesFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMMatrices __servant = null;
                    try
                    {
                        __servant = (FEMMatrices)__obj;
                    }
    ...
    public void
    setFields(final FEMMatricesFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
