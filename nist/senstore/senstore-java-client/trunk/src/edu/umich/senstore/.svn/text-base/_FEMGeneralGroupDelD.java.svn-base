...
public final class _FEMGeneralGroupDelD extends Ice._ObjectDelD implements _FEMGeneralGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMGeneralGroupFieldsHolder __result = new FEMGeneralGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMGeneralGroup __servant = null;
                    try
                    {
                        __servant = (FEMGeneralGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMGeneralGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
