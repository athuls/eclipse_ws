...
public final class _FEMPropertiesDelD extends Ice._ObjectDelD implements _FEMPropertiesDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMPropertiesFieldsHolder __result = new FEMPropertiesFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMProperties __servant = null;
                    try
                    {
                        __servant = (FEMProperties)__obj;
                    }
    ...
    public void
    setFields(final FEMPropertiesFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
