...
public final class _FEMMTForceDataDelD extends Ice._ObjectDelD implements _FEMMTForceDataDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMMTForceDataFieldsHolder __result = new FEMMTForceDataFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMMTForceData __servant = null;
                    try
                    {
                        __servant = (FEMMTForceData)__obj;
                    }
    ...
    public void
    setFields(final FEMMTForceDataFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
