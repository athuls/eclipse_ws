...
public final class _FEMTwoDSolidGroupDelD extends Ice._ObjectDelD implements _FEMTwoDSolidGroupDel
{
    public FEMNodePrx
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        __initCurrent(__current, "getAuxNode", Ice.OperationMode.Idempotent, __ctx);
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMTwoDSolidGroup __servant = null;
                    try
                    {
                        __servant = (FEMTwoDSolidGroup)__obj;
                    }
                    catch(ClassCastException __ex)
                    {
                        throw new Ice.OperationNotExistException(__current.id, __current.facet, __current.operation);
                    }
                    __result.value = __servant.getAuxNode(__current);
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMTwoDSolidGroupFieldsHolder __result = new FEMTwoDSolidGroupFieldsHolder();
        IceInternal.Direct __direct = null;
        try
        {
            __direct = new IceInternal.Direct(__current)
    ...
    public void
    setFields(final FEMTwoDSolidGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
