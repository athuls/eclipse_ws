...
public final class _FEMStrLinesDelD extends Ice._ObjectDelD implements _FEMStrLinesDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMStrLinesFieldsHolder __result = new FEMStrLinesFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMStrLines __servant = null;
                    try
                    {
                        __servant = (FEMStrLines)__obj;
                    }
    ...
    public void
    setFields(final FEMStrLinesFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
