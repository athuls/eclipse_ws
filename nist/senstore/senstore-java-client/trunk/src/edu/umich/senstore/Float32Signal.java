...
public final class Float32Signal implements java.lang.Cloneable, java.io.Serializable
{
    public long[] shape;
    ...
    public Float32Signal(long[] shape, float[] data, double[] t)
    {
        this.shape = shape;
        this.data = data;
        this.t = t;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        Float32Signal _r = null;
        try
        {
            _r = (Float32Signal)rhs;
        }
