...
public final class _FEMTwoDSolidDelM extends Ice._ObjectDelM implements _FEMTwoDSolidDel
{
    ...
    public void
    setFields(FEMTwoDSolidFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
