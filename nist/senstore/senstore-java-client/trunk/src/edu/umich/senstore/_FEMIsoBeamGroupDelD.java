...
public final class _FEMIsoBeamGroupDelD extends Ice._ObjectDelD implements _FEMIsoBeamGroupDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMIsoBeamGroupFieldsHolder __result = new FEMIsoBeamGroupFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMIsoBeamGroup __servant = null;
                    try
                    {
                        __servant = (FEMIsoBeamGroup)__obj;
                    }
    ...
    public void
    setFields(final FEMIsoBeamGroupFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
