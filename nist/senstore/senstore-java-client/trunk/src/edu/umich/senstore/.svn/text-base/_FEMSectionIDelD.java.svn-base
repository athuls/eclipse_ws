...
public final class _FEMSectionIDelD extends Ice._ObjectDelD implements _FEMSectionIDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSectionIFieldsHolder __result = new FEMSectionIFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSectionI __servant = null;
                    try
                    {
                        __servant = (FEMSectionI)__obj;
                    }
    ...
    public void
    setFields(final FEMSectionIFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
