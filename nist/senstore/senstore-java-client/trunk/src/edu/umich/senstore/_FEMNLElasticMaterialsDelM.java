...
public final class _FEMNLElasticMaterialsDelM extends Ice._ObjectDelM implements _FEMNLElasticMaterialsDel
{
    ...
    public void
    setFields(FEMNLElasticMaterialsFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
