...
public final class _FEMDampingDelD extends Ice._ObjectDelD implements _FEMDampingDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMDampingFieldsHolder __result = new FEMDampingFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMDamping __servant = null;
                    try
                    {
                        __servant = (FEMDamping)__obj;
                    }
    ...
    public void
    setFields(final FEMDampingFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
