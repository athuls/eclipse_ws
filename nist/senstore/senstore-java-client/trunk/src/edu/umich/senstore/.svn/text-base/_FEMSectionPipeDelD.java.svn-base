...
public final class _FEMSectionPipeDelD extends Ice._ObjectDelD implements _FEMSectionPipeDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMSectionPipeFieldsHolder __result = new FEMSectionPipeFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMSectionPipe __servant = null;
                    try
                    {
                        __servant = (FEMSectionPipe)__obj;
                    }
    ...
    public void
    setFields(final FEMSectionPipeFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
