...
public final class _FEMShellLayerDelD extends Ice._ObjectDelD implements _FEMShellLayerDel
{
        ...
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        final FEMShellLayerFieldsHolder __result = new FEMShellLayerFieldsHolder();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    FEMShellLayer __servant = null;
                    try
                    {
                        __servant = (FEMShellLayer)__obj;
                    }
    ...
    public void
    setFields(final FEMShellLayerFields fields, final String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
