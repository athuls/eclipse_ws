...
public final class _FEMLoadMassProportionalDelM extends Ice._ObjectDelM implements _FEMLoadMassProportionalDel
{
    ...
    public void
    setFields(FEMLoadMassProportionalFields fields, String[] fieldNames, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
