...
# All rights reserved
# $Id: sqlclient-tpl.py,v 1.7 2011/01/27 22:19:05 glinden Exp $
import sys
import os.path
import traceback
import logging
...
class Database:
    ...
    def __init__(self, username, passwd, hostname='localhost',
        ...
        id = self.UnitLabelToId['UnitMETRICTON']
        self.UnitIdToEnum[id] = \
                SenStore.Unit.UnitMETRICTON
        id = self.UnitLabelToId['UnitNEWTON']
        self.UnitIdToEnum[id] = \
                SenStore.Unit.UnitNEWTON
        id = self.UnitLabelToId['UnitKILONEWTON']
        self.UnitIdToEnum[id] = \
                SenStore.Unit.UnitKILONEWTON
        id = self.UnitLabelToId['UnitINCH']
        self.UnitIdToEnum[id] = \
                SenStore.Unit.UnitINCH
