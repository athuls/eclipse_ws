...
# All rights reserved
# $Id: sevenbeambridge.py,v 1.5 2011/01/29 01:44:30 glinden Exp $
import sys
import time
import logging
import numpy
...
## \file sevenbeambridge.py
#
# Demonstrates how to define a Finite Element Model directly in the SenStore
# database.
if __name__ == '__main__':
    ...
    #
    client = SenStoreClient(sys.argv, 'Seven Beam Bridge FE model creator client')
