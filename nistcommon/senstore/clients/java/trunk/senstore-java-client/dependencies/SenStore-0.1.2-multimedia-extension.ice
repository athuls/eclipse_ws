...
module SenStore {
  ...
  interface SenStoreMngr {
    ...
    /**
     * Adds the file to a web-accessible directory
     * @param file_name The name of the file on the server; e.g. "image.jpg"
     * @param file_type The type of the file. For now, use the 3-character
     *   file-extension; this should be normalized later.
     * @param desc_short A short description of the file.
     * @param desc_long A longer description of the file
     * @param bytes The bytes of the file
     */
    idempotent void uploadFile(string filename, string filetype,
        string descriptionShort, string descriptionLong, ByteSeq bytes);
  };
